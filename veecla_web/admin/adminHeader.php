            ...
            ?>
                ...
                <li class="nav-item">
                    ...
                    <div id="newsletter" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-primary py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Home</h6>
                            <a class="collapse-item" href="addNewsletter.php">Create Newsletter</a>
                            <a class="collapse-item" href="viewNewsletters.php">Newsletters</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="reports" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-primary py-2 collapse-inner rounded">
                            <h6 class="collapse-header">REPORT ANALYSIS</h6>
                            <a class="collapse-item" href="../home.php?id=home">User Searches</a>

                            <a class="collapse-item" href="viewProductAnalysis.php">Product Analysis</a>
                            <a class="collapse-item" href="../faqs.php?id=faqs">Units Added</a>
                            <a class="collapse-item" href="../products.php?id=product">Units Ordered</a>
                            <a class="collapse-item" href="../contact.php?id=contact">Units left</a>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#socials" aria-expanded="true" aria-controls="collapsePages">
                        <i class="fas fa-fw fa-camera"></i>
                        <span>Socials</span>
                    </a>
                    <div id="socials" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-primary py-2 collapse-inner rounded">
                            <h6 class="collapse-header">SOCIAL MEDIA</h6>
                            <a class="collapse-item" href="addSocial.php">Create Socials</a>

                            <a class="collapse-item" href="viewSocials.php">View Socials</a>
                            <a class="collapse-item" href="../faqs.php?id=faqs">Units Added</a>
                            <a class="collapse-item" href="../products.php?id=product">Units Ordered</a>
                            <a class="collapse-item" href="../contact.php?id=contact">Units left</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="chats" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-primary py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="adminChats.php">Chats</a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="adminprofile.php">
                                    ...
                                    <a class="dropdown-item" href="adminAccountSettings.php?id=<?= $row['id']?>">
