            ...
            <div class="col">
                <div class="card table-responsive shadow">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <h3>Profile image</h3> -->
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6" style="height:500px;">
                                <img src="../inc/profileUploads/<?= $row['profileImage'] ?>" class="img-fluid w-100 h-100" alt="">
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="card table-responsive">
                                    <div class="card-body">
                                        <h5 class="text-success">Account details</h5>
                                        <form action="../inc/userEdit.inc.php" method="post">
